    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bnum', models.CharField(max_length=12, null=True, verbose_name='B Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pdf', models.FileField(blank=True, null=True, upload_to=employee.models.PaperworkForm.user_dir_path)),
                ('uploaded', models.DateTimeField(blank=True, null=True)),
                ('requested', models.DateTimeField(auto_now_add=True)),
                ('processed', models.BooleanField(default=False)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='employee.paperwork')),
            ],
        ),
        migrations.CreateModel(
            name='OfficeHours',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('position', models.ForeignKey(default='Manager', on_delete=django.db.models.deletion.PROTECT, to='auth.group', to_field='name')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='employee',
            name='paperwork',
            field=models.ManyToManyField(through='employee.PaperworkForm', to='employee.Paperwork'),
        ),
        migrations.AddField(
            model_name='employee',
