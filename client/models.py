...
class Organization(models.Model):
    """
    All main contacts for all organizations that have previously ever been in a BSSL payment interaction. 
...
class OrgContact(models.Model):
    """
    List of organizations that have interacted with BSSL. 
    This includes the name of the organization and there SA number *if applicable*.
    If the orginization is not chartered by SA it will be labeled **"NON-SA"**.
    """
    name = models.CharField(max_length=200)
