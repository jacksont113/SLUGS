    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipment.systemaddon')),
            ],
            options={
                'verbose_name': 'Addon',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='client.organization')),
            ],
        ),
        migrations.CreateModel(
            name='Job',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('addons', models.ManyToManyField(blank=True, through='gig.AddonInstance', to='equipment.SystemAddon')),
                ('employees', models.ManyToManyField(through='gig.Job', to=settings.AUTH_USER_MODEL)),
                ('gig', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gig.gig')),
        ...
        migrations.AddField(
            model_name='job',
            name='linked_system',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='gig.systeminstance'),
        ),
        migrations.AddField(
            model_name='job',
            name='position',
        ...
        migrations.AddField(
            ...
            name='systemInstance',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gig.systeminstance'),
        ),
    ]
